...
import { GoashtaLogo } from "components/icons/Icons";
  ...
  let brand = (
    <Link
      ...
      <Stack direction='row' spacing='12px' align='center' justify='center'>
        {/* <Goashta Logo h='26px' w='175px' color={logoColor} /> */}
      </Stack>
  ...
  if (props.secondary === true) {
    brand = (
      <Link
        ...
        alignItems='center'
        color={mainText}>
        {/* <Goashta Logo h='26px' w='175px' my='32px' color={logoColor} /> */}
      </Link>
    );
    ...
    <SidebarContext.Provider value={{ sidebarWidth }}>
      <Flex
        ...
        <Flex w='100%' justifyContent={{ sm: "start", lg: "space-between" }}>
          ...
          {linksAuth}
          <Link href='https://www.Goashta -ui.com/pro'>
            <Button
              bg={bgButton}
              color={colorButton}
              fontSize='xs'
